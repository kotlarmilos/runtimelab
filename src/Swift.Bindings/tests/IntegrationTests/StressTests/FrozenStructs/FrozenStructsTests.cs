...
namespace BindingsGeneration.StressTests
{
    public class FrozenStructsTests : IClassFixture<FrozenStructsTests.TestFixture>
    {
        ...
        public static void TestSwiftStruct0()
        {
            ...
            long result = Swift.FrozenStructsTests.FrozenStructsTests.swiftFunc0(-23758, 148652722, 3833542748216839160, 21987, new F0_S0(3425626963407448, 989224444, 55562), new F0_S1(1751696348434043356), 14, new F0_S2(1047842));
        ...
        public static void TestSwiftStruct1()
        {
            ...
            long result = Swift.FrozenStructsTests.FrozenStructsTests.swiftFunc1(new F1_S0(6106136698885217102, 6195715435808, 121, 676336729, 51621), 121, new F1_S1(101), new F1_S2(-11974));
        ...
        public static void TestSwiftStruct8()
        {
            ...
            long result = Swift.FrozenStructsTests.FrozenStructsTests.swiftFunc8(48505, unchecked((nuint)8758330817072549915), 7130, 4163773298933598697, new F8_S0(1934119180), 2843311260726166700);
        ...
        public static void TestSwiftStruct9()
        {
            ...
            long result = Swift.FrozenStructsTests.FrozenStructsTests.swiftFunc9(3214937834123081267, 6846768, new F9_S0(1713527158921541), 25670, new F9_S1(1650872599), 39910);
